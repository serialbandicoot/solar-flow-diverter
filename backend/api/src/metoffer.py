...
class MetOffer:
    ...
    def loc_forecast(self, request, step, isotime=None):
        ...
        """
        return json.loads(self._query(VAL, FORECAST, ALL, request, step, isotime))
    ...
    def map_overlay_forecast(self):
        ...
        return json.loads(self._query(LAYER, FORECAST, ALL, CAPABILITIES, ""))

    def map_overlay_obs(self):
        """Returns capabilities data for observation map overlays."""
        return json.loads(self._query(LAYER, OBSERVATIONS, ALL, CAPABILITIES, ""))
